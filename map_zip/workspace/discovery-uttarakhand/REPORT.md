...
**Build date:** 2026-09-09 · **Principle enforced throughout:** REAL data only — every value is traceable to a fetched, permitted source; unverifiable fields are `null`, never invented.
...
|---|---|---|
| Destinations | `data/destinations.json` | 37 |
| Spiritual places | `data/spiritual.json` | 26 |
| Cultural places | `data/culture.json` | 7 |
| Activities / experiences | `data/activities.json` | 20 |
| Stays (49 KMVN + 2 heritage) | `data/stays.json` | 51 |
| Rentals (5 bike, 4 car) | `data/rentals.json` | 9 |
| Guides (UTDB-verified) | `data/guides.json` | 190 |
| **Total records** | | **340** |
